...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="moonbow"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/adam/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/adam/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/adam/.now_playing.log"
...
# time.sh {
	...
	export TMUX_POWERLINE_SEG_TIME_FORMAT="%I:%M"
